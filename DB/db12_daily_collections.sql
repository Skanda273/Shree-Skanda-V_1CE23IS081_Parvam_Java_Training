...
CREATE TABLE `daily_collections` (
  ...
  `net_collection` decimal(12,2) DEFAULT NULL,
...
INSERT INTO `daily_collections` VALUES (1,'2023-05-15',2000.00,375.00,NULL),(2,'2023-06-18',3000.00,600.00,NULL),(3,'2023-07-20',1500.00,150.00,NULL);
